...
NOTE: This is a legacy enhancement built on the "Fuji" version of the platform, and modern functionality in the Pattern Designer can be used for exploratory scanning instead.
